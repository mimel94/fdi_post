...
async def init_app():
    ...
    app.router.add_post('/aiortc/entrenar',entrenar)
    app.router.add_post('/aiortc/validar',validar)
    app.router.add_post('/aiortc/estado',estado)
    app.router.add_post('/aiortc/iniciar',inicio_asistencia)
    app.router.add_post('/aiortc/terminar',terminar_asistencia)
    app.router.add_post('/aiortc/enviar_muestra',muestra_asistencia)
    app.router.add_post('/aiortc/reporte',reporte_asistencia)
